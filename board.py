...
def set_up_board_buttons():
    ...
    tk.Button(text="0",bg="green",fg="white",padx=10, pady=54, command=lambda: guessnum(1,1)).grid(rowspan=3, row=1, column=1)                                                                                                                      
    r = 0
    ...
    for c in range(4):
        ...
        r = r + 3
        col = (r/3)+1
        tk.Button(root,text=str(r), bg="black",fg="white", padx=10, pady=10, command=lambda rw=rw, col=col: guessnum(rw,col)).grid(row=rw,column=int(col))
        r = r + 3
        col = (r/3)+1
        tk.Button(root,text=str(r), bg="red",fg="white", padx=10, pady=10, command=lambda rw=rw, col=col: guessnum(rw,col)).grid(row=rw,column=int(col))
    ...
    for fghfdhd in range(4):
        ...
        r = r + 3
        col = ((r+1)/3)+1
        tk.Button(root,text=str(r), bg="red",fg="white", padx=10, pady=10, command=lambda rw=rw, col=col: test()).grid(row=rw,column=int(col))
        r = r + 3
        col = ((r+1)/3)+1
        tk.Button(root,text=str(r), bg="black",fg="white", padx=10, pady=10, command=lambda rw=rw, col=col: test()).grid(row=rw,column=int(col))
...
def test(): # the default functon called when a button is clicked
    print('test')
